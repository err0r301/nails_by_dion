...
insert into appointments values(appointmentID, "102", "2024-08-08 20:30", "2024-08-08 20:30","Dion",2, "unconfirmed", "hair");
insert into appointments values(appointmentID, "102", "2024-08-12", "20:27", "unconfirmed", "Eyes");
...
create table notifications(notificationID int auto_increment primary key, dateTime_ datetime, message varchar(300), status_ varchar(15), userID int);
insert into notifications values(notificationID, "2024-08-08 20:27", "This is a message one", "approved", 101);
